...
- <code><a href="./src/resources/product-collections/product-collections.ts">ProductCollectionCreateResponse</a></code>
- <code><a href="./src/resources/product-collections/product-collections.ts">ProductCollectionRetrieveResponse</a></code>
...
- <code title="post /product-collections">client.productCollections.<a href="./src/resources/product-collections/product-collections.ts">create</a>({ ...params }) -> ProductCollectionCreateResponse</code>
- <code title="get /product-collections/{id}">client.productCollections.<a href="./src/resources/product-collections/product-collections.ts">retrieve</a>(id) -> ProductCollectionRetrieveResponse</code>
...
- <code><a href="./src/resources/product-collections/groups/groups.ts">GroupCreateResponse</a></code>

Methods:

- <code title="post /product-collections/{id}/groups">client.productCollections.groups.<a href="./src/resources/product-collections/groups/groups.ts">create</a>(id, { ...params }) -> GroupCreateResponse</code>
