...
describe('resource checkoutSessions', () => {
  test('create: only required params', async () => {
    const responsePromise = client.checkoutSessions.create({ product_cart: [{ product_id: 'product_id', quantity: 0 }] });
  ...
  test('preview: only required params', async () => {
    const responsePromise = client.checkoutSessions.preview({ product_cart: [{ product_id: 'product_id', quantity: 0 }] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
