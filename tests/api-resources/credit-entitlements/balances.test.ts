...
describe('resource balances', () => {
  test('retrieve: only required params', async () => {
    const responsePromise = client.creditEntitlements.balances.retrieve('customer_id', { credit_entitlement_id: 'credit_entitlement_id' });
  ...
  test('retrieve: required and optional params', async () => {
    const response = await client.creditEntitlements.balances.retrieve('customer_id', { credit_entitlement_id: 'credit_entitlement_id' });
  });
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.creditEntitlements.balances.list('credit_entitlement_id', {
  ...
  test('listGrants: only required params', async () => {
    const responsePromise = client.creditEntitlements.balances.listGrants('customer_id', { credit_entitlement_id: 'credit_entitlement_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('listLedger: only required params', async () => {
    const responsePromise = client.creditEntitlements.balances.listLedger('customer_id', { credit_entitlement_id: 'credit_entitlement_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
