...
export class Balances extends APIResource {
  retrieveLedger(query: BalanceRetrieveLedgerParams | null | undefined = {}, options?: RequestOptions): PagePromise<BalanceLedgerEntriesDefaultPageNumberPagination, BalanceLedgerEntry> {
    return this._client.getAPIList('/balances/ledger', DefaultPageNumberPagination<BalanceLedgerEntry>, { query, ...options });
  }
}
...
export interface BalanceLedgerEntry {
  ...
  event_type: 'payment' | 'refund' | 'refund_reversal' | 'dispute' | 'dispute_reversal' | 'tax' | 'tax_reversal' | 'payment_fees' | 'refund_fees' | 'refund_fees_reversal' | 'dispute_fees' | 'payout' | 'payout_fees' | 'payout_reversal' | 'payout_fees_reversal' | 'dodo_credits' | 'adjustment' | 'currency_conversion' | 'abandoned_cart_recovery_fee' | 'dunning_fees';
