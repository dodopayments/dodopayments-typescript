...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    "response": "{ id: string; created_at: string; customer_email?: string; customer_name?: string; payment_id?: string; payment_status?: string; }",
  ...
  },
  {
    ...
    "response": "{ client_secret: string; customer: { customer_id: string; email: string; name: string; metadata?: object; phone_number?: string; }; metadata: object; payment_id: string; total_amount: number; discount_id?: string; expires_on?: string; payment_link?: string; product_cart?: { product_id: string; quantity: number; amount?: number; }[]; }",
  ...
  },
  {
    ...
    "response": "{ id: string; business_id: string; created_at: string; customer: { customer_id: string; email: string; name: string; metadata?: object; phone_number?: string; }; license_key_id: string; name: string; product: { product_id: string; name?: string; }; }",
  ...
  },
  {
    ...
    "response": "{ id: string; business_id: string; created_at: string; license_key_id: string; name: string; }",
  ...
  },
  {
    ...
    "response": "{ business_id: string; created_at: string; customer_id: string; email: string; name: string; metadata?: object; phone_number?: string; }",
  ...
  },
  {
    ...
    "response": "{ items: { balance: number; created_at: string; currency: currency; customer_id: string; updated_at: string; }[]; total_balance_usd: number; }",
  ...
  },
  {
    ...
    "response": "{ id: string; after_balance: number; amount: number; before_balance: number; business_id: string; created_at: string; currency: string; customer_id: string; event_type: string; is_credit: boolean; reason?: string; reference_object_id?: string; }",
  ...
  },
  {
    ...
    "response": "{ balance: number; created_at: string; currency: string; customer_id: string; updated_at: string; }",
  ...
  },
  {
    ...
    "response": "{ business_id: string; created_at: string; is_partial: boolean; payment_id: string; refund_id: string; status: 'succeeded' | 'failed' | 'pending' | 'review'; amount?: number; currency?: string; reason?: string; }",
  ...
  },
  {
    ...
    "response": "{ business_id: string; created_at: string; customer: { customer_id: string; email: string; name: string; metadata?: object; phone_number?: string; }; is_partial: boolean; metadata: object; payment_id: string; refund_id: string; status: 'succeeded' | 'failed' | 'pending' | 'review'; amount?: number; currency?: string; reason?: string; }",
  ...
  },
  {
    ...
    "response": "{ amount: string; business_id: string; created_at: string; currency: string; customer: { customer_id: string; email: string; name: string; metadata?: object; phone_number?: string; }; dispute_id: string; dispute_stage: 'pre_dispute' | 'dispute' | 'pre_arbitration'; dispute_status: string; payment_id: string; is_resolved_by_rdr?: boolean; reason?: string; remarks?: string; }",
  ...
  },
  {
    ...
    "response": "{ amount: number; business_id: string; chargebacks: number; created_at: string; currency: string; fee: number; payment_method: string; payout_id: string; refunds: number; status: 'not_initiated' | 'in_progress' | 'on_hold' | 'failed' | 'success'; tax: number; updated_at: string; name?: string; payout_document_url?: string; remarks?: string; }",
  ...
  },
  {
    ...
    "httpMethod": "get",
    "summary": "",
    "description": "Returns the breakdown of a payout by event type (payments, refunds, disputes, fees, etc.) in the payout's currency. Each amount is proportionally allocated based on USD equivalent values, ensuring the total sums exactly to the payout amount.",
  ...
  },
  {
    ...
    "httpMethod": "get",
    "summary": "",
    "description": "Returns paginated individual balance ledger entries for a payout, with each entry's amount pro-rated into the payout's currency. Supports pagination via `page_size` (default 10, max 100) and `page_number` (default 0) query parameters.",
    ...
    "response": "{ id: string; created_at: string; event_type: string; original_amount: number; original_currency: string; payout_currency_amount: number; usd_equivalent_amount: number; description?: string; reference_object_id?: string; }",
  ...
  },
  {
    ...
    "response": "{ business_id: string; created_at: string; entitlements: { id: string; integration_config: object | object | object | object | object | object | object | object; integration_type: 'discord' | 'telegram' | 'github' | 'figma' | 'framer' | 'notion' | 'digital_files' | 'license_key'; name: string; description?: string; }[]; is_recurring: boolean; metadata: object; product_id: string; tax_category: 'digital_products' | 'saas' | 'e_book' | 'edtech'; updated_at: string; currency?: string; description?: string; image?: string; name?: string; price?: number; price_detail?: object | object | object; tax_inclusive?: boolean; }",
  ...
  },
  {
    ...
    "httpMethod": "post",
    "summary": "Gives a Short Checkout URL with custom slug for a product.\nUses a Static Checkout URL under the hood.",
    "description": "Gives a Short Checkout URL with custom slug for a product.\nUses a Static Checkout URL under the hood.",
  ...
  },
  {
    ...
    "response": "{ items: { brand_id: string; business_id: string; enabled: boolean; statement_descriptor: string; verification_enabled: boolean; verification_status: 'Success' | 'Fail' | 'Review' | 'Hold'; description?: string; image?: string; name?: string; reason_for_hold?: string; support_email?: string; url?: string; }[]; }",
  ...
  },
  {
    ...
    "response": "{ brand_id: string; business_id: string; enabled: boolean; statement_descriptor: string; verification_enabled: boolean; verification_status: 'Success' | 'Fail' | 'Review' | 'Hold'; description?: string; image?: string; name?: string; reason_for_hold?: string; support_email?: string; url?: string; }",
  ...
  },
  {
    ...
    "response": "{ id: string; created_at: string; description: string; metadata: object; updated_at: string; url: string; disabled?: boolean; filter_types?: string[]; rate_limit?: number; }",
  ...
  },
  {
    ...
    "response": "{ business_id: string; customer_id: string; event_id: string; event_name: string; timestamp: string; metadata?: object; }",
  ...
  },
  {
    ...
    "response": "{ id: string; aggregation: { type: 'count' | 'sum' | 'max' | 'last'; key?: string; }; business_id: string; created_at: string; event_name: string; measurement_unit: string; name: string; updated_at: string; description?: string; filter?: { clauses: object[] | object[]; conjunction: conjunction; }; }",
  ...
  },
  {
    ...
    "response": "{ id: string; business_id: string; created_at: string; name: string; overage_behavior: 'forgive_at_reset' | 'invoice_at_billing' | 'carry_deficit' | 'carry_deficit_auto_repay'; overage_enabled: boolean; precision: number; rollover_enabled: boolean; unit: string; updated_at: string; currency?: string; description?: string; expires_after_days?: number; max_rollover_count?: number; overage_limit?: number; price_per_unit?: string; rollover_percentage?: number; rollover_timeframe_count?: number; rollover_timeframe_interval?: 'Day' | 'Week' | 'Month' | 'Year'; }",
  ...
  },
  {
    ...
    "response": "{ id: string; balance: string; created_at: string; credit_entitlement_id: string; customer_id: string; overage: string; updated_at: string; last_transaction_at?: string; }",
  ...
  },
  {
    ...
    "description": "Returns a paginated list of credit grants with optional filtering by status.\n\n# Authentication\nRequires an API key with `Viewer` role or higher.\n\n# Path Parameters\n- `credit_entitlement_id` - The unique identifier of the credit entitlement\n- `customer_id` - The unique identifier of the customer\n\n# Query Parameters\n- `page_size` - Number of items per page (default: 10, max: 100)\n- `page_number` - Zero-based page number (default: 0)\n- `status` - Filter by status: active, expired, depleted\n\n# Responses\n- `200 OK` - Returns list of grants\n- `404 Not Found` - Credit entitlement not found\n- `500 Internal Server Error` - Database or server error",
