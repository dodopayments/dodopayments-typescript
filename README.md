...
[![NPM version](https://img.shields.io/npm/v/dodo-payments.svg)](https://npmjs.org/package/dodo-payments) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/dodo-payments)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/dodo-payments-node.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainlessapi.com/docs/guides/publish), this will become: `npm install dodo-payments`
...
To do the inverse, add `import "dodo-payments/shims/node"` (which does import polyfills).
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/stainless-sdks/dodo-payments-node/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/dodo-payments-node/issues) with questions, bugs, or suggestions.
